...
def test_home(page: Page, live_server_url: str):
    ...
    expect(page).to_have_title("National Life Group Knowledgebase Chatbot")
...
def test_chat(sized_page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Type a new question (e.g. how do you calculate age?)").click()
    page.get_by_placeholder("Type a new question (e.g. how do you calculate age?)").fill(
...
def test_ask(sized_page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Example: how do you calculate age?").click()
    page.get_by_placeholder("Example: how do you calculate age?").fill("Whats the dental plan?")
    page.get_by_placeholder("Example: how do you calculate age?").click()
    page.get_by_label("Submit question").click()
